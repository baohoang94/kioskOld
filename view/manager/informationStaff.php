		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<ul class="list-inline">
					...
					<li class="page_prev"><a href="/listAllStaff"><i aria-hidden="true"></i> Danh sách nhân viên</a></li>
					<li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
									...
									<div class="col-sm-4">
										<div class="form_add">
											<div class="form-group">
												...
												<input type="email" title="" maxlength="100"  placeholder="Email" id="" value="<?php echo @arrayMap($data['Staff']['email']);?>" class="form-control" name="email" required="" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[a-zA-Z]{2,3}$">
											</div>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form_add">
											<div class="form-group">
												...
												<input type="text" name="phone" maxlength="50"  placeholder="Số điện thoại" value="<?php echo @arrayMap($data['Staff']['phone']);?>" class="form-control" required="" >
											</div>
										</div>
									</div>
								...
								<div class="col-sm-4">
									...
									<div class="col-sm-4">
										<div class="form_add">
											<div class="form-group">
												...
												<input type="text" maxlength="200"  placeholder="Số nhà, đường" name="address" class="form-control" value="<?php echo @arrayMap($data['Staff']['address']);?>" required="">
											</div>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form_add">
											<div class="form-group">
												...
												<input type="text" name="dateTrial" id="" placeholder="Ngày vào thử việc" class="input_date form-control" required="" data-inputmask="'alias': 'date'"  pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" title="Nhập đúng định dạng ngày tháng dd/mm/yyyy. Ví dụ: 24/12/1989" value="<?php echo @arrayMap($data['Staff']['dateTrial']);?>">
											</div>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form_add">
											<div class="form-group">
												...
												<input type="text" name="dateStart" id="" placeholder="Ngày làm chính thức" class="input_date form-control" required="" data-inputmask="'alias': 'date'"  pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" title="Nhập đúng định dạng ngày tháng dd/mm/yyyy. Ví dụ: 24/12/1989" value="<?php echo @arrayMap($data['Staff']['dateStart']);?>">
											</div>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form_add">
											<div class="form-group">
												...
												<input type="text" title="" maxlength="200" id="" placeholder="Vị trí, chức danh công việc" class="form-control" name="position" required="" value="<?php echo @arrayMap($data['Staff']['position']);?>">
											</div>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form_add">
											<div class="form-group">
												...
												<input type="text" title="" maxlength="200" id="" placeholder="Quản lý trực tiến" class="form-control" name="directManager" required="" value="<?php echo @arrayMap($data['Staff']['directManager']);?>">
											</div>
										</div>
									</div>
									<div class="col-sm-4">
									...
									<div class="col-sm-12">
										<div class="form-group">
											...
											<textarea class="form-control" maxlength="3000" rows="3"  placeholder="Lý do sửa" name="reason" required=""><?php echo @arrayMap($data['Staff']['reason']);?></textarea>

										</div>
									</div>
									<div class="col-sm-12">
										<div class="form-group">
											<button class="btn_ad">Lưu</button>
														<span class="btn_ad_back"><a href="/listAllStaff">Quay lại</a></span>
													</div>
												</div>
								</div>
							</div>
