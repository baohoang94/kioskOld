		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<ul class="list-inline">
					...
					<li class="page_now"><a href="/listAllStaff">Danh sách nhân viên</a></li>
					<li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
					<li class="page_now"><?php echo $data['Staff']['code'];?></li>
					<li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
					<li class="page_now">Phân quyền</li>
				</ul>
							...
							<div class="col-sm-12">
								<div class="col-sm-12">
									<div class="form-group">
										<label>Danh sách quyền<span class="color_red">*</span>: </label>
													...
													foreach ($namg2 as $key2 => $value2) {
														...
														if(!empty($value2['sub'])){
															foreach ($value2['sub'] as $keySub2 => $sub2) {
																if(!empty($data['Staff']['permission']) && in_array($sub2['permission'], $data['Staff']['permission'])){
																	$check2= 'checked';
																	$checkGroup= true;
																}else{
																	$check2= '';
													...
													foreach ($namg3 as $key3 => $value3) {
														...
														if(!empty($value3['sub'])){
															foreach ($value3['sub'] as $keySub3 => $sub3) {
																if(!empty($data['Staff']['permission']) && in_array($sub3['permission'], $data['Staff']['permission'])){
																	$check3= 'checked';
																	$checkGroup= true;
																}else{
																	$check3= '';
