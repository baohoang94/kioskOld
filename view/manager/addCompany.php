		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<ul class="list-inline">
					<!-- <li class="back_page"><a href="/listCompany"><i class="fa fa-chevron-left" aria-hidden="true"></i></a></li> -->
					...
					<li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
					<li class="page_now"><?php if(empty($data)){echo'Thêm công ty mới';}else{echo'Chỉnh sửa công ty';}?></li>
				</ul>
			...
			<!-- <div class="main_list_p "> -->
				<div class="main_add_p">
					<form action="" method="post">
						...
						?>
												<input type="hidden" name="" value="<?php echo @arrayMap($data['Company']['code']);?>">
								...
								<div class="col-sm-4">
									<div class="form_add">
										<div class="form-group">
											...
											<input type="text" pattern="([a-zA-Z0-9-]+)" title="Nhập mã không chứa nội dung khoảng trắng, ký tự có dấu. Chỉ sử dụng chữ cái (a-z. A-Z), số, dấu gạch ngang " maxlength="50" id="updatecode" placeholder="Mã công ty" class="form-control checkcode" name="code" required="" value="<?php echo @arrayMap($data['Company']['code']);?>" <?php if(!empty($data['Company']['code']))echo'disabled';?> >
										</div>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form_add">
										<div class="form-group">
											...
											<input type="text" title="" maxlength="50" id="" placeholder="Tên công ty" class="form-control"  name="name" required="" value="<?php echo @arrayMap($data['Company']['name']);?>">
										</div>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form_add">
										<div class="form-group">
											...
											<input type="text" title="" maxlength="50" id="" value="<?php echo @arrayMap($data['Company']['nameBoss']);?>" placeholder="Người phụ trách" class="form-control" name="nameBoss" required="">
										</div>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form_add">
										<div class="form-group">
											...
											<input type="text" title="" maxlength="50" id="" placeholder="Mã số thuế" class="form-control checkcode"  name="taxCode" required="" value="<?php echo @arrayMap($data['Company']['taxCode']);?>">
										</div>
									</div>
								</div>
								<div class="col-sm-4">
								...
								<div class="col-sm-4">
									<div class="form_add">
										<div class="form-group">
											...
											<input type="text" title="" maxlength="50" id="" placeholder="Số điện thoại" class="form-control" name="phone" required="" value="<?php echo @arrayMap($data['Company']['phone']);?>">
										</div>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form_add">
										<div class="form-group">
											...
											<input type="email" title="" maxlength="50" id="" placeholder="Email" class="form-control"  name="email" required="" value="<?php echo @arrayMap($data['Company']['email']);?>" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[a-zA-Z]{2,3}$">
										</div>
									</div>
								</div>
											...
											<select name="area" placeholder="" class="form-control" required="">
												...
												<?php
													...
													foreach($listArea as $area){
														if(empty($data['Company']['area']) || $data['Company']['area']!=$area['id']){
											...
											<select required name="idCity" class="form-control" placeholder="Tỉnh/Thành phố" onchange="getDistrict(this.value, 0)">
						                        ...
						                        if (!empty($listCityKiosk['Option']['value']['allData'])) {
						                            foreach ($listCityKiosk['Option']['value']['allData'] as $city) {
						                                if (!isset($data['Company']['idCity']) || $data['Company']['idCity'] != $city['id']) {
								...
								<div class="col-sm-4">
									<div class="form_add">
										<div class="form-group">
											...
											<input type="text" title="" maxlength="500" id="" placeholder="Số nhà, đường" class="form-control"  name="address" required="" value="<?php echo @arrayMap($data['Company']['address']);?>">
										</div>
									</div>
								</div>
								<div class="col-sm-12" >
									<div class="form-group">
										<label>Ghi chú: </label>
										<textarea class="form-control" maxlength="3000" placeholder="Ghi chú" value="" rows="3" name="note" ><?php echo @arrayMap($data['Company']['note']);?></textarea>
