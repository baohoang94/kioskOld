		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<ul class="list-inline">
					...
					<li class="page_now">
						Tổng hợp doanh thu theo thẻ(BC09)
					</li>
				</ul>
			</div>
									...
									<form action="" method="GET">
										...
										<td>
											<select name="idChannel" class="form-control">
												...
												<?php if(!empty($listChannelProduct)){
										...
										foreach ($listData as $key => $value) {
											...
											if($value['Transfer']['typedateEndPay']=2||$value['Transfer']['typedateEndPay']=4){
												...
												<tr>
													...
													<td><?php echo @$place[$key]['Place']['code'];?></td>
													<td><?php echo @$place[$key]['Place']['name'];?></td>
													<td><?php echo @$listChannelProduct['Option']['value']['allData'][$value['Transfer']['idChannel']]['name'];?></td>
													...
													<td><?php echo @$codeStaff['Staff']['code'];?></td>
												</tr>
												<?php
											}
											# code...
