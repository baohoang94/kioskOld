		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<ul class="list-inline">
					...
					<li class="page_now">Báo cáo doanh thu kênh phân phối toàn hệ thống</li>
				</ul>
							...
							<table class="table table-bordered table-hover">
								<thead>
									<tr>
										...
										<th class="text_table">Kênh phân phối</th>
											...
											<tr>
												...
												if(!empty($listTransfer)){
													foreach ($listTransfer as $key => $cua) {
														$product=$modelProduct->getProduct($cua['Transfer']['idProduct']);
														if($product['Product']['idChannel']==$value['id']){
