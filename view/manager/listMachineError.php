					...
					<table class="table table-bordered table-hover">
						<thead>
							<tr>
								...
								<th class="text_table">NV phụ trách</th>
								<th class="text_table">Thời gian lỗi</th>
						...
						<tbody>
							...
							if(!empty($listData)){
								foreach($listData as $data){
									...
									echo '<tr>
									<td><a href="infoMachine?id='.$data['Machine']['id'].'">'.$data['Machine']['name'].'</a></td>
									<td><a href="infoMachine?id='.$data['Machine']['id'].'">'.$data['Machine']['code'].'</a></td>
									<td>'.$codeasset.'</td>
									<td>'.$data['Machine']['imei'].'</td>
									<td><a href="/infoPlace?id='.@$place[$key]['Place']['id'].'">'.@$place[$key]['Place']['name'].'</a></td>
									<td><a href="'.$urlHomes.'infoStaff?id='.$data['Machine']['idStaff'].'">'.$data['Machine']['codeStaff'].'</a></td>
									<td class="text_table">'.date('H:i:s d/m/Y',@$data['Machine']['timeError']).'</td>
									<td>
									...
									<li><a href="/infoMachineError?id='.$data['Machine']['id'].'" title="Xem"><i class="fa fa-eye" aria-hidden="true"></i></a></li>
									...
									<li><a href="/listHistoryBugMachine?id='.$data['Machine']['id'].'" title="Lịch sử lỗi máy" class="bg_red"><i class="fa fa-history" aria-hidden="true"></i></a></li>
									</ul>
									</td>
									</tr>';
								}
