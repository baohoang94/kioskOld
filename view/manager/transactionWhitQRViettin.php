		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<ul class="list-inline">
					...
					<li class="page_now">Lịch sử giao dịch bằng QR VietinBank</li>
				</ul>
							...
							<table class="table table-bordered">
								<form action="" method="GET">
									...
									<tr>
										...
										<td>
											<input type="text"  name="money" maxlength="50"  id="" placeholder=" Doanh thu bán hàng(vnđ)" class="input_money form-control" value="<?php echo @arrayMap($_GET['money']);?>">
										</td>
										<td>
										...
										<td>
											<input type="text" name="quantity" maxlength="50"  id="" placeholder="Số lượng sản phẩm" class="input_money form-control" value="<?php echo @arrayMap($_GET['quantity']);?>">
										</td>        
