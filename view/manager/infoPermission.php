		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<ul class="list-inline">
					...
					<li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
					<li class="page_now"><?php if(!empty($data)){ echo'Xem chi tiết khối phòng ban: '.@$data['Permission']['name'].'';}else{ echo'Thêm khối phòng ban';}?></li>
				</ul>
								...
								<div class="col-sm-4">
									<div class="form_add">
										<div class="form-group">
											...
											<input type="text" disabled="" title="" maxlength="50" id="" placeholder="Tên khối phòng ban" class="form-control"  name="name" required="" value="<?php echo @arrayMap($data['Permission']['name']);?>">
										</div>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form_add">
										<div class="form-group">
											...
											<input type="text" disabled="" title="" maxlength="50" id="" value="<?php echo @arrayMap($data['Permission']['leader']);?>" class="form-control" placeholder="Tên trưởng khối phòng ban" name="leader" required="">
										</div>
									</div>
								</div>
								<!-- <div class="col-sm-12">
									...
									<div class="form-group">
												...
												foreach($listPermission as $key=>$permissionGroup){
													...
													echo '<div class="col-md-4">
															<ul class="list-unstyled list_addPer">
																<li class="has_sub_staff"><span><input type="checkbox" disabled id="check'.$key.'"> <label for="">'.$permissionGroup['name'].' <i class="fa fa-angle-down"></i></label></span>
																	<ul class="list-unstyled sub_staff">';
																		foreach($permissionGroup['sub'] as $keySub=>$sub){
																			...
																			echo '<li><input name="permission[]" '.$check.' type="checkbox" disabled value="'.$sub['permission'].'" id="check'.$key.'_'.$keySub.'"> <label for="check'.$key.'_'.$keySub.'">'.$sub['name'].'</label></li>';
																		}
													echo			'</ul>
																</li>
															</ul>
										...
										<script>
											$(document).ready(function() {
												...
												// $('.has_sub_staff span input').click(function(){
												// 	$(this).parent().next('.sub_staff input').not(this).prop('checked', this.checked);
												// });
												
												// $('.has_sub_staff span input').click(function(){
												// 	$(this).parent().parent().find('.sub_staff input').prop("checked",$(this).prop("checked"));
												// });

												// $('.has_sub_staff span input').click(function(){
												// 	$(".sub_staff li input").prop("checked",$(this).prop("checked"));
												// });
											});
										</script> -->
										<div class="row">
