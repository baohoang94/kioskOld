		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<ul class="list-inline">
					...
					<li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
					<li class="page_now"><?php if(!empty($data)){ echo'Chỉnh sửa  chi nhánh';}else{ echo'Thêm chi nhánh mới';}?></li>
				</ul>
								...
								<div class="col-sm-4">
									<div class="form_add">
										<div class="form-group">
											...
											<input type="text" title="" maxlength="50" id="" placeholder="Tên chi nhánh" class="form-control" name="name" required="" value="<?php echo @arrayMap($data['Branch']['name']);?>">
										</div>
									</div>
								</div>
								<div class="col-sm-4">
								...
								<div class="col-sm-4">
									<div class="form_add">
										<div class="form-group">
											...
											<input type="text" title="" maxlength="50" id="" placeholder="Số điện thoại" class="form-control"  name="phone" required="" value="<?php echo @arrayMap($data['Branch']['phone']);?>">
										</div>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form_add">
										<div class="form-group">
											...
											<input type="email" title="" maxlength="50" id="" placeholder="Email" class="form-control"  name="email" required="" value="<?php echo @arrayMap($data['Branch']['email']);?>" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[a-zA-Z]{2,3}$">
										</div>
									</div>
								</div>
								<div class="col-sm-4">
								...
								<div class="col-sm-4">
									<div class="form_add">
										<div class="form-group">
											...
											<select  name="idDistrict" class="form-control" placeholder="Huyện/Quận" id="listDistrict"  required onchange="getWards(idCity.value,this.value, 0)">
								...
								<div class="col-sm-4">
									<div class="form_add">
										<div class="form-group">
											...
											<input type="text" title="" maxlength="500" id="" placeholder="Số nhà, đường" class="form-control"  name="address" required="" value="<?php echo @arrayMap($data['Branch']['address']);?>">
										</div>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form_add">
										<div class="form-group">
											...
											<input type="text" title="" maxlength="50" id="" placeholder="Người phụ trách" value="<?php echo @arrayMap($data['Branch']['nameBoss']);?>" class="form-control" name="nameBoss" required="">
										</div>
									</div>
								</div>
								<div class="col-sm-12">
									<div class="form-group">
										<label>Ghi chú: </label>
										<textarea class="form-control" value="Ghi chú" placeholder="Ghi chú" rows="3" name="note" maxlength="3000"><?php echo @arrayMap($data['Branch']['note']);?></textarea>
