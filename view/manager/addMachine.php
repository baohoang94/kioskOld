											...
											<div class="row">
												<div class="col-sm-12">
													...
													<div class="col-sm-4">
														<div class="form_add">
															<div class="form-group">
																...
																<input type="text" maxlength="50" id="updatecode" value="<?php echo @arrayMap($data['Machine']['codeasset']);?>" placeholder="Mã tài sản" pattern="([a-zA-Z0-9-]+)" title="Nhập mã không chứa nội dung khoảng trắng, ký tự có dấu. Chỉ sử dụng chữ cái (a-z. A-Z), số, dấu gạch ngang " class="form-control checkcode" name="codeasset" required="">
															</div>
														</div>
													</div>
													<div class="col-sm-4">
													...
													<div class="col-sm-4">
														<div class="form_add">
															<div class="form-group">
																...
																<input type="text" title="" maxlength="19" id="" value="<?php echo @arrayMap($data['Machine']['priceMachine']);?>" placeholder="Giá máy" class="input_money form-control"  name="priceMachine" required="">
															</div>
														</div>
													</div>
													<div class="col-sm-4">
															...
															<div class="form-group">
																...
																<select class="form-control" name="status">
																	...
																	foreach($listStatusMachine as $status){
																		if(empty($data['Machine']['status']) || $data['Machine']['status']!=$status['id']){
													...
													<div class="col-sm-4">
														<div class="form_add">
															<div class="form-group">
																...
																<input type="text" maxlength="50" value="<?php echo @$data['Machine']['dateInstallation'];?>" placeholder="Ngày lắp đặt máy tại điểm bán"  name="dateInstallation" id=""  data-inputmask="'alias': 'date'" pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" title="Nhập đúng định dạng ngày tháng dd/mm/yyyy. Ví dụ: 24/12/1989" class="input_date form-control" required="">
															</div>
														</div>
													</div>
													<div class="col-sm-4">
													...
													<div class="col-sm-4">
														<div class="form_add">
															<div class="form-group" style="position: relative;">
																...
																<input type="text" maxlength="50" value="<?php echo @arrayMap($data['Machine']['codeStaff']);?>" placeholder="Mã nhân viên" name="codeStaff" id=""  class="form-control checkcode" onkeyup="showResult(this.value);">
																<div id='livesearch' style="background-color:#F0F0F0; position:absolute;z-index: 100;width:100%"></div>
															</div>
														</div>
													</div>
													<div class="col-sm-4">
													...
													<div class="col-sm-4">
														<div class="form_add">
															<div class="form-group">
																<label>Cho phép trả lại tiền thừa <span class="color_red">*</span>: </label>
																<select class="form-control" name="moneyBack">
																	<option value="0">Không cho</option>
																	<option value="1" <?php if(isset($data['Machine']['moneyBack']) && $data['Machine']['moneyBack']==1) echo 'selected';?>>Cho phép</option>
																</select>
															</div>
														</div>
													</div>
												...
												<div class="col-sm-12">
													<div class="form-group">
														...
														<span class="btn_ad_back"><a href="/listMachine">Quay lại</a></span>
													</div>
												</div>
											...
											<div class="col-sm-12">
												<div class="form-group">
													...
													<div class="col-sm-8">
														...
														&nbsp; Tọa độ GPS 
														<input type="text" name="coordinates"  id="coordinates" class="text_area" placeholder="Nhập tọa độ GPS" value="<?php
														if (isset($tmpVariable['data']['Machine']['coordinates']))
															echo $tmpVariable['data']['Machine']['coordinates'];
														?>" />
														<br />
														<input type="text" id="address" class="form-control" value="" placeholder="Nhập thông tin địa điểm" style="margin-top: 20px;" />
														<br />
				...
				<script type="text/javascript">
					...
					function initialize() {
						...
						map = new google.maps.Map(mapDiv, {
							<?php
							if (isset($data['Machine']['coordinates'])&&$data['Machine']['coordinates']!=null) {
								echo 'center: new google.maps.LatLng(' . @$data['Machine']['coordinates'].'),';
							} else {
								echo '';
							}
							?>
						...
						marker = new google.maps.Marker({
							...
							<?php
							if (isset($data['Machine']['coordinates'])&&$data['Machine']['coordinates']!=null) {
								echo 'position: new google.maps.LatLng(' . @$data['Machine']['coordinates'] . '),';
							} else {
...
function showResult(str) {
  ...
  xmlhttp.open("GET","/liveSearch?key="+str,true);
  xmlhttp.send();
}
</script>
