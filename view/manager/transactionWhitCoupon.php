		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<ul class="list-inline">
					...
					<li class="page_now">Lịch sử giao dịch Coupon</li>
				</ul>
						...
						<div class="table-responsive table1">
							<table class="table table-bordered">
								<form action="" method="GET">
									<tr>
										<td>
											<input type="text" maxlength="50" class="form-control" placeholder="Mã coupon" name="coupon" value="<?php echo @arrayMap($_GET['coupon'])?>">
										</td>
										<td>
								...
								<tbody>
									...
									if(!empty($listData)){
										...
										foreach($listData as $data){
											...
											<td class="text_table_right">'.@$data['Transfer']['coupon'].'</td>
										...
										echo '<tr><td align="center" colspan="14">Chưa có dữ liệu</td></tr>';
									}
									?>
