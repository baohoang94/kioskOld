		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<ul class="list-inline">
					...
					<li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
					<li class="page_now"><?php if(!empty($data)){ echo'Chỉnh sửa lỗi';}else{echo'Thêm thông tin lỗi mới';}?></li>
				</ul>
			</div>
			<div id="">
						...
						<div class="col-sm-12">
								...
								<div class="col-sm-4">
									<div class="form_add">
										<div class="form-group">
											...
											<input type="text" pattern="([a-zA-Z0-9-]+)" title="Nhập mã không chứa nội dung khoảng trắng, ký tự có dấu. Chỉ sử dụng chữ cái (a-z. A-Z), số, dấu gạch ngang " maxlength="50" id="updatecode" class="form-control checkcode" placeholder="Mã máy" name="codeMachine" required="" value="<?php echo @arrayMap($data['Error']['codeMachine']);?>">
										</div>
									</div>
								</div>
								<div class="col-sm-4">
							...
							<div class="col-sm-4">
								<div class="form_add">
									<div class="form-group">
										...
										<input type="text" title="" maxlength="50" id="" class="form-control" placeholder="KTV sửa chữa" name="nameTechnicians" required="" value="<?php echo @arrayMap($data['Error']['nameTechnicians']);?>">
									</div>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form_add">
									<div class="form-group">
										...
										<input type="text" maxlength="50" value="<?php echo @$data['Error']['dayError'];?>" name="dayError" id="" placeholder="Ngày bắt đầu hỏng" data-inputmask="'alias': 'date'" class="input_date form-control" pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" title="Nhập đúng định dạng ngày tháng dd/mm/yyyy. Ví dụ: 24/12/1989" required="">
									</div>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form_add">
									<div class="form-group">
										...
										<input type="text" maxlength="50" value="<?php echo @$data['Error']['dayReportError'];?>" name="dayReportError" id="" placeholder="Ngày báo hỏng" data-inputmask="'alias': 'date'" class="input_date form-control" pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" title="Nhập đúng định dạng ngày tháng dd/mm/yyyy. Ví dụ: 24/12/1989" required="">
									</div>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form_add">
									<div class="form-group">
										...
										<input type="text" maxlength="50" value="<?php echo @$data['Error']['dayStart'];?>" name="dayStart" id="" placeholder="Ngày bắt đầu khắc phục" data-inputmask="'alias': 'date'" class="input_date form-control" pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" title="Nhập đúng định dạng ngày tháng dd/mm/yyyy. Ví dụ: 24/12/1989" required="">
									</div>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form_add">
									<div class="form-group">
										...
										<input type="text" maxlength="50" value="<?php echo @$data['Error']['dayEnd'];?>" name="dayEnd" id="" placeholder="Ngày hoàn thành khắc phục" data-inputmask="'alias': 'date'" class="input_date form-control" pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" title="Nhập đúng định dạng ngày tháng dd/mm/yyyy. Ví dụ: 24/12/1989" required="">
									</div>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form_add">
									<div class="form-group">
										...
										<select name="status" class="form-control" placeholder="Tỉnh/Thành phố" required="">
								...
								<div class="col-sm-4">
									<div class="form_add" id="">
										<div class="form-group ">
											...
											<input type="text" title="" maxlength="50" id="errorName" class="form-control tenLoi"  name="name" required="" placeholder="Tên lỗi" value="<?php echo @arrayMap($data['Error']['name']);?>">
										</div>
									</div>
								</div>
								<div class="col-sm-12">
									<div class="form-group">
										...
										<textarea class="form-control" maxlength="3000" name="note" placeholder="Mô tả lỗi" required="" id="noteError" rows="3" required=""><?php echo @arrayMap($data['Error']['note']);?></textarea>
							...
							<div class="col-sm-12">
								<div class="form-group">
									...
									<!-- <input id="btntest" type="button" value="Reset" class="btn_ad" onclick="window.location.href = '<?php echo $urlNow;?>' " /> -->
