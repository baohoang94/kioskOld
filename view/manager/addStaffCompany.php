		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<ul class="list-inline">
					<!-- <li class="back_page"><a href="/listStaffCompany?idCompany=<?php echo $_GET['idCompany'];?>&idBranch=<?php echo $_GET['idBranch'];?>&idPermission=<?php echo $_GET['idPermission'];?>"><i class="fa fa-chevron-left" aria-hidden="true"></i></a></li> -->
					...
					<li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
					<li class="page_prev"><a href="/groupPermission?idCompany=<?php echo $_GET['idCompany'];?>&idBranch=<?php echo $_GET['idBranch'];?>"> Danh sách nhóm phòng ban</a></li>
					<li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
					<li class="page_prev"><a href="/listStaffCompany?idCompany=<?php echo $_GET['idCompany'];?>&idBranch=<?php echo $_GET['idBranch'];?>&idPermission=<?php echo $_GET['idPermission'];?>"> Danh sách nhân viên</a></li>
					<li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
					<li class="page_now"><?php if(!empty($data)){echo'Chỉnh sửa nhân viên';}else{ echo'Thêm nhân viên mới';}?></li>
				</ul>
								...
								<div class="col-sm-4">
									...
									<div class="col-sm-12">
										<div class="form-group">
											...
											<span class="btn_ad_back"><a href="/listStaffCompany?idCompany=<?php echo $_GET['idCompany'];?>&idBranch=<?php echo $_GET['idBranch'];?>&idPermission=<?php echo $_GET['idPermission'];?>">Quay lại</a></span>
										</div>
									</div>
								</div>
							</div>
